              ...
              <RevealOnScroll delay={70}>
                <div className="card" style={{padding:"1.5rem",height:"100%"}}>
                  <div style={{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.875rem"}}>
                    ...
                    <span className="chip" style={{fontSize:"0.6875rem"}}>Precision Engineering</span>
                  </div>
                  ...
                  <p style={{fontSize:"0.8125rem",color:"var(--text-3)",lineHeight:1.65}}>Implemented a full manufacturing ERP covering production planning, shop floor control, quality management, and supply chain — replacing 6 disconnected systems with a single integrated platform.</p>
                </div>
              </RevealOnScroll>
              <RevealOnScroll delay={70}>
                <div className="card" style={{padding:"1.5rem",height:"100%"}}>
                  <div style={{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.875rem"}}>
                    <span className="chip chip-blue" style={{fontSize:"0.6875rem"}}>Multi-Site ERP</span>
                    <span className="chip" style={{fontSize:"0.6875rem"}}>Food Production</span>
                  </div>
                  <div style={{fontFamily:"var(--font-heading)",fontWeight:700,fontSize:"0.9375rem",color:"var(--text-1)",marginBottom:"0.375rem"}}>dsm-firmenich</div>
                  <div style={{fontSize:"0.8125rem",fontWeight:600,color:"var(--blue-light)",marginBottom:"0.625rem"}}>55% reduction in month-end close time</div>
                  <p style={{fontSize:"0.8125rem",color:"var(--text-3)",lineHeight:1.65}}>Deployed a multi-entity ERP across 5 manufacturing and distribution facilities — unifying financials, procurement, production, and compliance into one system with consolidated group reporting.</p>
                </div>
              </RevealOnScroll>
              <RevealOnScroll delay={70}>
                <div className="card" style={{padding:"1.5rem",height:"100%"}}>
                  <div style={{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.875rem"}}>
                    <span className="chip chip-blue" style={{fontSize:"0.6875rem"}}>Distribution ERP</span>
                    <span className="chip" style={{fontSize:"0.6875rem"}}>Food and Dairy</span>
                  </div>
                  <div style={{fontFamily:"var(--font-heading)",fontWeight:700,fontSize:"0.9375rem",color:"var(--text-1)",marginBottom:"0.375rem"}}>NADEC</div>
                  <div style={{fontSize:"0.8125rem",fontWeight:600,color:"var(--blue-light)",marginBottom:"0.625rem"}}>30% improvement in order fulfilment speed</div>
                  <p style={{fontSize:"0.8125rem",color:"var(--text-3)",lineHeight:1.65}}>Built a custom ERP for dairy and food distribution covering production scheduling, cold chain inventory, route planning, and retailer invoicing — handling 10,000+ SKUs across 3 distribution centres.</p>
                </div>
              </RevealOnScroll>
          </div>
        </div>
