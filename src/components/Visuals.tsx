...
export const PanelChrome = ({
  ...
  <svg viewBox={`0 0 ${width} ${height}`} fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <circle cx={29} cy={18} r={4.5} fill="#F7941D" opacity=".7" />
    <circle cx={42} cy={18} r={4.5} fill="#22C55E" opacity=".7" />
    {title && <text x={58} y={22} fontSize={8} fontWeight={600} fill="#8FD4F2" fontFamily="Inter,sans-serif">{title}</text>}
  ...
  <div style={{ position: "relative", width: "100%" }}>
    <PanelChrome width={520} height={340} title="Enterprise Web Application" subtitle="jubiliants-erp.app">
      ...
      <g>
        ...
        <rect x={12} y={44} width={60} height={16} rx={4} fill="#1B75BB" opacity={.25} />
        <text x={20} y={56} fontSize={7.5} fontWeight={600} fill="#8FD4F2" fontFamily="Inter,sans-serif">Dashboard</text>
        ...
        <rect x={430} y={43} width={78} height={18} rx={9} fill="#1B75BB" />
      ...
      <g>
        ...
        {[
          ...
          <g key={item.label}>
            {item.active && <rect x={2} y={80 + i * 34} width={76} height={26} rx={5} fill="#1B75BB" opacity={.4} />}
            <rect x={10} y={87 + i * 34} width={10} height={10} rx={2} fill={item.active ? "#2E9BD6" : "#334155"} />
            <text x={26} y={96 + i * 34} fontSize={7} fill={item.active ? "#8FD4F2" : "#475569"} fontFamily="Inter,sans-serif">{item.label}</text>
          </g>
        ))}
      </g>
      {/* Main content */}
      <g>
        ...
        <MetricCard x={284} y={102} label="Pending Invoices" value="₹8.2L" sub="12 awaiting approval" subColor="#F7941D" />
        <MetricCard x={380} y={102} label="Team Utilisation" value="87%" sub="Within target range" subColor="#2E9BD6" />
        {/* Chart area */}
        ...
        <polyline points="109,245 130,233 151,239 172,220 193,228 214,208 235,214 256,201 277,207 298,196 319,201 340,191"
          stroke="#29ABE2" strokeWidth={1.5} fill="none" strokeLinecap="round" opacity={.8} />
        {/* Activity feed */}
        ...
        {[
          ...
          { t: "New order from Apollo", c: "#2E9BD6", time: "14m ago" },
          { t: "Low stock alert: Item A", c: "#F7941D", time: "1h ago" },
      ...
      <g>
        ...
        <text x={360} y={316} fontSize={6.5} fill="#2E9BD6" fontFamily="Inter,sans-serif">✓ Mobile-first · WCAG 2.1 · PWA-ready</text>
      </g>
    </PanelChrome>
  </div>
);
    ...
    <PanelChrome width={520} height={340} title="SaaS Platform Architecture" subtitle="Multi-tenant · Cloud-native">
      ...
      <g className="hv-g1">
        ...
        {[
          ...
          <g key={u.label}>
            <rect x={u.x} y={58} width={82} height={40} rx={7} fill="#1B75BB" stroke="#1B75BB" strokeWidth={.5} strokeOpacity={.4} />
            <text x={u.x + 41} y={76} fontSize={12} textAnchor="middle" fontFamily="Inter,sans-serif">{u.icon}</text>
            <text x={u.x + 41} y={90} fontSize={6.5} fill="#8FD4F2" fontFamily="Inter,sans-serif" textAnchor="middle">{u.label}</text>
          </g>
        ))}
        {/* Arrows down */}
        {[57, 147, 237, 327, 417].map(x => (
          <line key={x} x1={x} y1={98} x2={x} y2={110} stroke="#14548C" strokeWidth={1} strokeDasharray="3 2" />
        ))}
      </g>
      {/* Layer 2: API Gateway */}
      <g className="hv-g2">
        ...
        <line x1={258} y1={152} x2={258} y2={162} stroke="#14548C" strokeWidth={1} strokeDasharray="3 2" />
      </g>
      {/* Layer 3: Services */}
      <g className="hv-g3">
        ...
        {[
          ...
          <g key={s.label}>
            <rect x={s.x} y={176} width={86} height={38} rx={7} fill="#142240" stroke="#1B75BB" strokeWidth={.5} strokeOpacity={.5} />
            <rect x={s.x} y={176} width={4} height={38} rx={2} fill="#1B75BB" opacity={.6} />
            <text x={s.x + 12} y={192} fontSize={6.5} fontWeight={600} fill="#8FD4F2" fontFamily="Inter,sans-serif">{s.label}</text>
      ...
      <g className="hv-g5">
        ...
        {[
          ...
          <g key={m.label}>
            ...
            <text x={m.x} y={322} fontSize={9} fontWeight={700} fill="#2E9BD6" fontFamily="Inter,sans-serif">{m.val}</text>
          </g>
        ))}
      </g>
    </PanelChrome>
...
export const CloudArchVisual = () => (
  <div style={{ position: "relative", width: "100%" }}>
    <PanelChrome width={520} height={340} title="Cloud Migration Architecture" subtitle="Azure · AWS · GCP">
      ...
      {/* Migration flow */}
      <g className="hv-g3">
        <text x={192} y={54} fontSize={7} fill="#F7941D" fontFamily="Inter,sans-serif" fontWeight={600} letterSpacing={.06}>MIGRATION PATHWAY</text>
        {["Assess", "Plan", "Migrate", "Optimise"].map((step, i) => (
          <g key={step}>
            ...
            <text x={190} y={88 + i * 52} fontSize={7} fill="#F7941D" fontFamily="Inter,sans-serif">{step}</text>
      ...
      <g className="hv-g2">
        ...
        {[
          ...
          { label: "Managed SQL PaaS", sub: "Azure SQL · RDS", color: "#2E9BD6" },
          { label: "Geo-redundant Backup", sub: "99.999% durability", color: "#22C55E" },
          { label: "Zero-trust Network", sub: "Private endpoints", color: "#2E9BD6" },
  ...
  <div style={{ position: "relative", width: "100%" }}>
    <PanelChrome width={520} height={340} title="Generative AI Application Platform" subtitle="RAG · Fine-tuning · Agents">
      ...
      <g className="hv-g1">
        ...
        <text x={26} y={62} fontSize={8} fontWeight={600} fill="#8FD4F2" fontFamily="Inter,sans-serif">AI Assistant — Enterprise</text>
        ...
        {[
          ...
          <g key={i}>
            {msg.role === "user" ? (
              <g>
                <rect x={80} y={msg.y} width={152} height={msg.text.length > 40 ? 28 : 20} rx={8} fill="#1B75BB" />
                <text x={86} y={msg.y + 13} fontSize={6.5} fill="#8FD4F2" fontFamily="Inter,sans-serif">{msg.text.substring(0, 38)}{msg.text.length > 38 ? "…" : ""}</text>
              </g>
            ) : (
              <g>
      ...
      <g className="hv-g2">
        ...
        {[
          { label: "Document Ingestion", sub: "PDF, DOCX, DB, APIs", y: 58, color: "#1B75BB" },
          { label: "Chunking & Embedding", sub: "OpenAI text-embedding-3", y: 106, color: "#1B75BB" },
          { label: "Vector Store", sub: "Pinecone / Weaviate", y: 154, color: "#2E9BD6" },
          { label: "LLM Reasoning", sub: "GPT-4o / Claude 3.5", y: 202, color: "#1B75BB" },
          ...
          <g key={step.label}>
            ...
            {i < 4 && (
              <path d={`M380 ${step.y + 38} L380 ${step.y + 48}`} stroke="#14548C" strokeWidth={1} strokeDasharray="3 2" />
            )}
          </g>
        ))}
  ...
  <div style={{ position: "relative", width: "100%" }}>
    <PanelChrome width={520} height={340} title="CCTV Intelligence Platform" subtitle="Real-time · 200+ cameras">
      ...
      <g className="hv-g1">
        ...
        <rect x={150} y={100} width={12} height={14} fill="#14548C" opacity={.5} />
        <rect x={170} y={100} width={12} height={14} fill="#14548C" opacity={.5} />
        ...
        {/* Scanning overlay */}
        <line x1={20} y1={95} x2={212} y2={95} stroke="#2E9BD6" strokeWidth={1} opacity={.5} className="hv-dash" />
        <text x={116} y={76} fontSize={9.1} fill="#2E9BD6" fontFamily="Inter,sans-serif" textAnchor="middle">Monitoring…</text>
        {/* Stats overlay */}
      ...
      <g className="hv-g2">
        ...
        <MetricCard x={236} y={64} w={80} h={48} label="Cameras Active" value="204" sub="All online" subColor="#2E9BD6" />
        ...
        {[
          ...
          { label: "PPE non-compliance", count: 9, color: "#F7941D" },
          { label: "Fire / smoke risk", count: 1, color: "#EF4444" },
          { label: "Loitering detected", count: 4, color: "#F7941D" },
        ].map((cat, i) => (
          <g key={cat.label}>
        ...
        <text x={236} y={186} fontSize={8.5} fill="#2E9BD6" fontFamily="Inter,sans-serif">⚡ Avg alert response: 4.2s · Auto-routed to security team</text>
      </g>
      {/* Use cases grid */}
      <g className="hv-g3">
      ...
      <g className="hv-g4">
        ...
        {["Camera Feed", "Frame Capture", "AI Inference", "Risk Scoring", "Alert / Action"].map((step, i) => (
          <g key={step}>
            <rect x={16 + i * 102} y={278} width={94} height={28} rx={6} fill="#142240" stroke="#1B75BB" strokeWidth={.4} strokeOpacity={.5} />
            <text x={63 + i * 102} y={292} fontSize={8.5} fill="#8FD4F2" fontFamily="Inter,sans-serif" textAnchor="middle" fontWeight={500}>{step}</text>
      ...
      <g className="hv-g5">
        ...
        <text x={420} y={327} fontSize={6.5} fill="#2E9BD6" fontFamily="Inter,sans-serif">ONNX Optimised</text>
      </g>
    </PanelChrome>
  </div>
);
  ...
  <div style={{ position: "relative", width: "100%" }}>
    <PanelChrome width={520} height={340} title="Enterprise AI Chatbot Platform" subtitle="Omnichannel · NLP · Integrated">
      ...
      <g className="hv-g1">
        ...
        <rect x={16} y={44} width={210} height={32} rx={9} fill="#1B75BB" />
        <rect x={16} y={64} width={210} height={12} fill="#1B75BB" />
        <circle cx={34} cy={60} r={9} fill="#1B75BB" />
        ...
        <text x={48} y={69} fontSize={6} fill="#8FD4F2" fontFamily="Inter,sans-serif">● Online · Typically replies instantly</text>
        ...
        {[
          ...
          <g key={i}>
            {msg.role === "user" ? (
              <g>
                <rect x={100} y={msg.y} width={118} height={msg.text.length > 30 ? 26 : 18} rx={8} fill="#1B75BB" />
                <text x={106} y={msg.y + 12} fontSize={6.5} fill="#8FD4F2" fontFamily="Inter,sans-serif">{msg.text.substring(0, 28)}{msg.text.length > 28 ? "…" : ""}</text>
              </g>
            ) : (
              <g>
        ...
        {/* Quick reply buttons */}
        <rect x={22} y={270} width={60} height={16} rx={8} fill="#253347" stroke="#1B75BB" strokeWidth={.5} />
        <text x={52} y={281} fontSize={6} fill="#8FD4F2" textAnchor="middle" fontFamily="Inter,sans-serif">Dec 20</text>
        ...
        <rect x={196} y={295} width={20} height={20} rx={10} fill="#1B75BB" />
      ...
      <g className="hv-g3">
        ...
        {[
          ...
          { label: "Containment Rate", val: "73%", color: "#2E9BD6" },
          { label: "Avg CSAT Score", val: "4.7/5", color: "#22C55E" },
          { label: "Languages Supported", val: "12+", color: "#2E9BD6" },
        ].map((m, i) => (
          <g key={m.label}>
  ...
  <div style={{ position: "relative", width: "100%" }}>
    <PanelChrome width={520} height={340} title="Machine Learning Platform" subtitle="MLOps · AutoML · Production">
      ...
      <g className="hv-g1">
        ...
        <text x={30} y={165} fontSize={6} fill="#2E9BD6" fontFamily="Inter,sans-serif">Training: 97.2%</text>
      ...
      <g className="hv-g2">
        ...
        {[
          ...
          <g key={f.label}>
            ...
            <rect x={370} y={68 + i * 17} width={110 * f.pct} height={7} rx={3.5} fill="#1B75BB" opacity={0.5 + f.pct * 0.5} />
      ...
      <g className="hv-g3">
        ...
        {["Data Prep", "Feature Eng.", "Model Train", "Evaluation", "Registry", "Serve / API", "Monitor"].map((step, i) => (
          <g key={step}>
            <rect x={16 + i * 72} y={204} width={65} height={36} rx={6} fill="#142240" stroke="#1B75BB" strokeWidth={.4} strokeOpacity={.5} />
            <text x={48 + i * 72} y={219} fontSize={6} fill="#8FD4F2" fontFamily="Inter,sans-serif" textAnchor="middle" fontWeight={500}>{step}</text>
    ...
    <PanelChrome width={520} height={340} title="Enterprise Resource Planning — Unified Dashboard" subtitle="Manufacturing Module">
      ...
      <g className="hv-g1">
        ...
        {["Finance", "HR & Payroll", "Procurement", "Inventory", "Production", "Sales", "Reports"].map((tab, i) => (
          <g key={tab}>
            {i === 3 && <rect x={14 + i * 72} y={36} width={66} height={24} fill="#1B75BB" opacity={.3} />}
            <text x={47 + i * 72} y={52} fontSize={7} fill={i === 3 ? "#8FD4F2" : "#475569"} fontFamily="Inter,sans-serif" textAnchor="middle" fontWeight={i === 3 ? 600 : 400}>{tab}</text>
          </g>
        ))}
      </g>
      {/* KPIs */}
      <g className="hv-g2">
        <MetricCard x={16} y={66} w={112} h={56} label="Total Stock Value" value="₹2.4Cr" sub="Across 3 warehouses" subColor="#2E9BD6" />
        <MetricCard x={136} y={66} w={112} h={56} label="Items Below Reorder" value="14" sub="⚠ Action needed" subColor="#F7941D" />
      ...
      <g className="hv-g3">
        ...
        {[
          ...
          { code: "RM-2018", desc: "Aluminium Alloy 6061", wh: "WH-A", qty: "124", req: "200", val: "₹3.1L", status: "Low", sc: "#F7941D", bg: "rgba(245,158,11,.08)" },
  ...
  <div style={{ position: "relative", width: "100%", display: "flex", gap: "1rem", justifyContent: "center" }}>
    <svg viewBox="0 0 520 340" fill="none" xmlns="http://www.w3.org/2000/svg"
      ...
      <g className="hv-g1">
        ...
        <rect x={30} y={124} width={96} height={18} rx={9} fill="#1B75BB" />
        <text x={78} y={137} fontSize={7} fontWeight={600} fill="white" textAnchor="middle" fontFamily="Inter,sans-serif">Book Appointment</text>
        {[{ t: "Today 2:00 PM", s: "Confirmed ✓", c: "#22C55E" }, { t: "Tomorrow 10:30 AM", s: "Pending…", c: "#F7941D" }].map((apt, i) => (
          <g key={i}>
      ...
      <g className="hv-g2">
        ...
        {/* Simplified map grid */}
        {[0, 1, 2, 3].map(i => <line key={i} x1={166} y1={68 + i * 17} x2={284} y2={68 + i * 17} stroke="#14548C" strokeWidth={.5} />)}
        {[0, 1, 2, 3, 4].map(i => <line key={i} x1={186 + i * 24} y1={58} x2={186 + i * 24} y2={128} stroke="#14548C" strokeWidth={.5} />)}
        <circle cx={210} cy={86} r={7} fill="#1B75BB" />
        ...
        <circle cx={270} cy={72} r={5} fill="#F7941D" opacity={.8} />
        {/* Task cards */}
        {[
          { t: "Job #4421 — HVAC Service", s: "In Progress", c: "#2E9BD6", bg: "rgba(46,155,214,.1)" },
          { t: "Job #4438 — Inspection", s: "Scheduled", c: "#F7941D", bg: "rgba(245,158,11,.1)" },
      ...
      <g className="hv-g3">
        ...
        <text x={349} y={76} fontSize={10} fontWeight={700} fill="#2E9BD6" textAnchor="middle" fontFamily="Inter,sans-serif">94%</text>
        ...
        {[
          ...
          <g key={i}>
            ...
            <rect x={326} y={114 + i * 24} width={3} height={19} rx={1} fill="#1B75BB" opacity={.7} />
      ...
      <g className="hv-g4">
        ...
        <rect x={455} y={38} width={46} height={16} rx={5} fill="#1B75BB" />
        ...
        <rect x={459} y={90} width={38} height={14} rx={7} fill="#1B75BB" />
    ...
    <PanelChrome width={520} height={300} title="Enterprise Software Architecture" subtitle="3-tier · Microservices · Cloud-native">
      ...
      <g className="hv-g1">
        ...
        {["Web Browser", "Mobile App", "Admin Portal", "API Consumers"].map((c, i) => (
          <g key={c}>
            <rect x={16 + i * 124} y={58} width={116} height={30} rx={6} fill="#1B75BB" stroke="#1B75BB" strokeWidth={.5} strokeOpacity={.5} />
            <text x={74 + i * 124} y={77} fontSize={7.5} fill="#8FD4F2" textAnchor="middle" fontFamily="Inter,sans-serif">{c}</text>
          </g>
        ))}
        {/* Arrows */}
      ...
      <g className="hv-g2">
        ...
        {["Auth Service", "Business Logic", "API Gateway", "Notification Svc", "Report Engine", "Integration Hub"].map((svc, i) => (
          <g key={svc}>
            <rect x={24 + i * 80} y={122} width={72} height={54} rx={6} fill="#142240" stroke="#1B75BB" strokeWidth={.4} strokeOpacity={.4} />
            <rect x={24 + i * 80} y={122} width={72} height={4} rx={2} fill="#1B75BB" opacity={.6} />
            <text x={60 + i * 80} y={148} fontSize={6.5} fill="#8FD4F2" textAnchor="middle" fontFamily="Inter,sans-serif" fontWeight={500}>{svc.split(" ")[0]}</text>
            <text x={60 + i * 80} y={160} fontSize={6.5} fill="#8FD4F2" textAnchor="middle" fontFamily="Inter,sans-serif">{svc.split(" ").slice(1).join(" ")}</text>
      ...
      <g className="hv-g3">
        ...
        {[
          { label: "PostgreSQL", sub: "Transactional DB", color: "#1B75BB", x: 16 },
          { label: "Redis", sub: "Cache & Sessions", color: "#EF4444", x: 132 },
          { label: "Elasticsearch", sub: "Search & Analytics", color: "#F7941D", x: 248 },
          { label: "Blob Storage", sub: "Files & Attachments", color: "#2E9BD6", x: 364 },
        ].map(d => (
          <g key={d.label}>
      ...
      <g className="hv-g5">
        ...
        <text x={54} y={278} fontSize={6.5} fill="#2E9BD6" fontFamily="Inter,sans-serif">GitHub Actions</text>
        <text x={145} y={278} fontSize={6.5} fill="#5A6E85" fontFamily="Inter,sans-serif">| Deploy:</text>
        <text x={185} y={278} fontSize={6.5} fill="#2E9BD6" fontFamily="Inter,sans-serif">Azure / AWS / Docker / K8s</text>
        <text x={340} y={278} fontSize={6.5} fill="#5A6E85" fontFamily="Inter,sans-serif">| Monitoring:</text>
        <text x={396} y={278} fontSize={6.5} fill="#2E9BD6" fontFamily="Inter,sans-serif">Datadog · Sentry</text>
      </g>
    </PanelChrome>
  </div>
);
...
export const AIAutomationVisual = () => (
  <svg viewBox="0 0 520 340" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <circle cx="29" cy="18" r="4.5" fill="#F7941D" opacity=".7" />
    <circle cx="42" cy="18" r="4.5" fill="#22C55E" opacity=".7" />
    <text x="58" y="22" fontSize="10.4" fontWeight="600" fill="#8FD4F2" fontFamily="Inter,sans-serif">Intelligent Process Automation — Live Monitor</text>
...
export const AITransformVisual = () => (
  <svg viewBox="0 0 520 340" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <text x="16" y="22" fontSize="11.1" fontWeight="600" fill="#8FD4F2" fontFamily="Inter,sans-serif">AI-Powered Enterprise Platform</text>
    ...
    {[
      ...
      { label: "Demand Prediction", val: "94.1% acc", trend: "ML Model v3", x: 288, tc: "#2E9BD6" },
    ...
    <rect x="16" y="132" width="488" height="80" rx="9" fill="#142240" stroke="#1B75BB" strokeWidth=".75" strokeOpacity=".5" />
    {[
      ...
      <g key={mod.label}>
        <rect x={mod.x} y={140} width={114} height={64} rx={6} fill="#141F35" stroke="#1B75BB" strokeWidth=".4" strokeOpacity=".4" />
        <rect x={mod.x} y={140} width={114} height={4} rx={2} fill="#1B75BB" opacity=".6" />
        <text x={mod.x + 8} y={158} fontSize={7} fontWeight={600} fill="#8FD4F2" fontFamily="Inter,sans-serif">{mod.label}</text>
    ...
    {[
      ...
      <g key={src.label}>
        ...
        <line x1={src.x + 48} y1={270} x2={src.x + 48} y2={280} stroke="#14548C" strokeWidth="1" strokeDasharray="3 2" />
      </g>
    ))}
...
export const CaseStudiesDashVisual = () => (
  <svg viewBox="0 0 520 320" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <rect width="520" height="36" rx="12" fill="#2D3D55" />
    <rect y="24" width="520" height="12" fill="#2D3D55" />
    <text x="16" y="22" fontSize="11.1" fontWeight="600" fill="#8FD4F2" fontFamily="Inter,sans-serif">Project Outcomes — 300+ Delivered</text>
    ...
    {[
      { label: "Healthcare", pct: 28, color: "#2E9BD6" },
      { label: "Manufacturing", pct: 22, color: "#1B75BB" },
      { label: "Education", pct: 18, color: "#1B75BB" },
      { label: "Logistics", pct: 14, color: "#29ABE2" },
      { label: "FinTech", pct: 10, color: "#8FD4F2" },
    ...
    {[
      ...
      { icon: "💰", label: "Cost Reduction", val: "35%", sub: "operational savings", color: "#2E9BD6", x: 148, y: 214 },
      { icon: "🎯", label: "Error Reduction", val: "74%", sub: "vs manual baseline", color: "#22C55E", x: 280, y: 214 },
      { icon: "⏱", label: "Faster Delivery", val: "3×", sub: "process speed increase", color: "#2E9BD6", x: 400, y: 214 },
    ].map((m) => (
      <g key={m.label}>
    ...
    {industries.map((ind) => (
      <div key={ind.name} className="industry-grid-card" style={{
        ...
        <div style={{
          ...
          background: "var(--blue-dim)", border: "1px solid rgba(27,117,187,.2)",
...
export const CustomAppsVisual = () => (
  <svg viewBox="0 0 520 320" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <circle cx="29" cy="18" r="4.5" fill="#F7941D" opacity=".7" />
    <circle cx="42" cy="18" r="4.5" fill="#22C55E" opacity=".7" />
    <text x="58" y="22" fontSize="11.1" fontWeight="600" fill="#8FD4F2" fontFamily="Inter,sans-serif">Application Portfolio Overview</text>
    ...
    {[
      ...
      { icon: "🏦", name: "Loan Origination", type: "FinTech System", users: "120 staff", status: "Testing", sc: "#F7941D", bg: "rgba(245,158,11,.08)", x: 186, y: 164 },
      { icon: "🛒", name: "B2B E-Commerce", type: "Commerce Platform", users: "8,200 buyers", status: "Build", sc: "#2E9BD6", bg: "rgba(46,155,214,.08)", x: 358, y: 164 },
    ].map((app) => (
      <g key={app.name}>
    ...
    <text x="390" y="301" fontSize="9.1" fill="#2E9BD6" fontFamily="Inter,sans-serif">◉ All production systems healthy</text>
  </svg>
);
...
export const TransformationJourneyV2 = () => (
  <svg viewBox="0 0 640 480" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    {[94,190,286,382].map((y)=>(
      <g key={y}>
        <line x1="207" y1={y} x2="423" y2={y} stroke="#14548C" strokeWidth="10" strokeLinecap="round" opacity=".15"/>
        <line x1="207" y1={y} x2="423" y2={y} stroke="#2E9BD6" strokeWidth="2" strokeDasharray="8 5" className="hv-dash" opacity=".7"/>
        <text x="315" y={y+4} fontSize="10.4" fill="#29ABE2" fontFamily="Inter,sans-serif" textAnchor="middle" fontWeight="600">→ Migrating</text>
      </g>
    ))}

    {/* ── TRANSFORMATION PILLARS (centre) ── */}
    {[
      {label:"☁ Cloud Migration",sub:"Azure / AWS multi-region",color:"#2E9BD6",y:52},
      {label:"🔗 Data Integration",sub:"Unified real-time data layer",color:"#8B5CF6",y:148},
      {label:"⚡ Process Automation",sub:"AI-powered workflows",color:"#F7941D",y:244},
    ...
    {[
      ...
      {label:"📊 Real-time Analytics",note:"Executive dashboards · Auto-reports",outcome:"Decision speed: 3× faster",color:"#2E9BD6",y:148},
...
export const GlobalDeliveryVisual = () => (
  <svg viewBox="0 0 640 480" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <rect width="640" height="40" rx="14" fill="#1D2D45"/>
    <rect y="26" width="640" height="14" fill="#1D2D45"/>
    <text x="16" y="25" fontSize="13" fontWeight="600" fill="#8FD4F2" fontFamily="Inter,sans-serif">Jubiliants Software Solutions · Global Delivery Network</text>
    ...
    <circle cx="404" cy="160" r="14" fill="#1B75BB" stroke="#29ABE2" strokeWidth="2"/>
    <circle cx="404" cy="160" r="7" fill="#29ABE2"/>
    <circle cx="404" cy="160" r="20" fill="none" stroke="#2E9BD6" strokeWidth="1.5" opacity=".4" className="hv-pulse"/>
    <circle cx="404" cy="160" r="28" fill="none" stroke="#2E9BD6" strokeWidth="1" opacity=".2" className="hv-pulse" style={{animationDelay:".8s"}}/>
    <rect x="362" y="134" width="84" height="18" rx="5" fill="#1D2D45" stroke="#3D5068" strokeWidth=".5"/>
    <text x="404" y="146" fontSize="10.4" fontWeight="700" fill="#8FD4F2" fontFamily="Inter,sans-serif" textAnchor="middle">HQ · Hyderabad</text>
    ...
    {[
      ...
      <g key={i}>
        <line x1={n.cx} y1={n.cy} x2="404" y2="160" stroke="#14548C" strokeWidth="1.5" strokeDasharray="6 4" opacity=".5"/>
        <circle cx={n.cx} cy={n.cy} r="7" fill="#1D2D45" stroke="#2E9BD6" strokeWidth="1.5"/>
        <circle cx={n.cx} cy={n.cy} r="4" fill="#2E9BD6" opacity=".8"/>
    ...
    {[
      {label:"Software Engineers", pct:55, color:"#1B75BB"},
      {label:"AI & ML Specialists", pct:20, color:"#8B5CF6"},
      {label:"QA & DevOps",        pct:15, color:"#29ABE2"},
